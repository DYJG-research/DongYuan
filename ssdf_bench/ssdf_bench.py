...
from benchmark_core import TCMDataLoader
from evaluators import (
    MultipleChoiceEvaluator,
    LLMJudgeEvaluator,
)
from benchmark_core.model_interface import ModelInterface,APIModelInterface, LocalModelInterface
from benchmark_core.report_generator import ReportGenerator
from benchmark_core.utils import setup_logging, save_checkpoint, load_checkpoint
...
def main():
    ...
    parser.add_argument("--api_key", default="-",help="API Key (API mode). Set via OPENAI_API_KEY env var or this argument.")
    parser.add_argument("--model_path",default="-", help="Local model path (Local mode), the evaluation path for local loading")
    parser.add_argument("--config_file", default="./configs/benchmark_config.example.json", help="Configuration file path")
    parser.add_argument("--output_dir", default="./results/benchmark_run", help="Output directory")
